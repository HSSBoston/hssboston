...
That bridge became especially important as my interests expanded into piano, tennis, science, and economics. These interests led me to interdisciplinary projects, including astronomical sonification, which uses coding, music, and astronomy to make complex visual information understandable through sound; a tennis statistics method that combines probability and coding to summarize a player’s overall performance as a predictive metric; and a microeconomic model of pet ownership, which mathematically models and computationally implements how households balance companionship, care, time, and cost. What excites me most is using technology and quantitative thinking to connect fields that may seem unrelated and to approach questions that cannot be answered from only one perspective.

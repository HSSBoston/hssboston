...
That bridge became especially important as my interests expanded into piano, tennis, science, and economics. These interests have led me to interdisciplinary projects such as astronomical sonification, which combines coding, music, and astronomy to make complex visual information understandable through sound.  I have also developed a probabilistic tennis metric that uses coding and statistics to summarize and predict a player’s overall performance, as well as a microeconomic model that computationally explores how households balance the companionship, care, time, and costs in pet ownership. What excites me most is using technology and quantitative thinking to connect fields that may seem unrelated and to explore questions that cannot be answered from only one perspective.

Well, to be fair, I still have a soft spot for boxes full of Lego; my dream is to buy every Lego set in the world and build my own Lego empire!

You can find all my projects [here](https://github.com/HSSBoston?tab=repositories) at GitHub and a few of them at [my Devpost portfolio page](https://devpost.com/HSSBoston). I have completed Harvard University’s [CS50P](https://www.edx.org/learn/python/harvard-university-cs50-s-introduction-to-programming-with-python) and [CS50T](https://courses.edx.org/certificates/b50eb41b15ce49508ec52c2eb52a4472), Girls Who Code's summer program on data science and AI, and Python Institute’s associate certification ([PCAP](https://verify.openedg.org/?id=5bbh.0ER9.RGyM)).

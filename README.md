...
- Conference papers:
  - Hanna Suzuki, "Audio Augmented Reality for Celestial Objects through Music-theoretic and Spatial Sonification," In *Proc. of 5th EAI Conference on Computer Science and Education in Computer Science​​ (CSECS)*, Boston, MA, November 2026 (30% acceptance rate). [preprint](https://github.com/HSSBoston/astro-audio-ar/blob/main/docs/csecs26-final.pdf), [project page](https://github.com/HSSBoston/astro-audio-ar)
